        ...
        <section className="max-w-4xl mx-auto px-6 mb-16">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
            <div className="glass-card p-8 rounded-3xl border border-[#E5E0D2] dark:border-white/5">
              ...
              <p className="text-xs font-sans text-[#222222] dark:text-white/60 leading-relaxed mb-4 font-semibold dark:font-light">
              ...
              <ul className="space-y-2 text-xs font-sans text-[#222222] dark:text-white/80 font-semibold dark:font-light">
