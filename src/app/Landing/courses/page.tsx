            ...
            >
              ...
              <div className={`lg:col-span-5 ${idx % 2 === 1 ? "lg:order-last" : ""}`}>
                <div className="relative aspect-[4/3] rounded-[2rem] overflow-hidden border border-gold-primary/20 shadow-2xl group">
                  ...
                  <span className="absolute bottom-6 left-6 bg-[#FAF9F6]/80 dark:bg-[#0D0F12]/80 border border-gold-primary/30 text-gold-dark dark:text-gold-accent text-[9px] font-sans tracking-[0.2em] uppercase px-4 py-1.5 rounded-full">
                    {course.tag}
                  </span>
                </div>
              </div>
              ...
              <div className="lg:col-span-7 flex flex-col text-left">
                ...
                <h2 className="text-3xl md:text-4xl font-serif font-light text-[#111111] dark:text-white mb-6">
                  {course.title}
                </h2>
                
                <p className="text-xs md:text-sm font-sans text-[#222222] dark:text-white/70 leading-relaxed font-semibold dark:font-light mb-8">
                  {course.overview}
                </p>
                ...
                <ul className="space-y-3 font-serif text-xs md:text-sm text-[#222222] dark:text-white/80 mb-8 pl-4 border-l border-gold-primary/20 font-semibold dark:font-light">
                ...
                <div className="flex flex-wrap items-center justify-between border-t border-[#E5E0D2] dark:border-white/10 pt-6 gap-6">
                  <div className="flex flex-col text-left font-sans text-xs text-[#222222]/60 dark:text-white/50 tracking-wider">
                    <span>INSTRUCTOR: <strong className="text-[#111111] dark:text-white font-bold dark:font-medium">{course.instructor}</strong></span>
                    <span className="mt-1">SCHEDULE: <strong className="text-[#111111] dark:text-white font-bold dark:font-medium">{course.schedule}</strong></span>
                  </div>
                  ...
                  <button
                    ...
                    className="px-6 py-2.5 rounded-full bg-gold-primary hover:bg-gold-accent text-[#0D0F12] text-xs font-sans tracking-[0.2em] uppercase font-semibold transition-all duration-300 shadow-md"
                  >
                    Enroll / Inquire
                  </button>
                </div>
